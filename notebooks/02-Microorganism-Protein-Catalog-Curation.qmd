slurm_shell_do(
  ...
  fasta_path = tst,
  nbins = 5, 
  output_dir = "/central/groups/MazmanianLab/joeB/Downloads/scrap"
  )
)
---
...
<<<<<<< HEAD
#### **Unified Human Gastrointestinal Genome (UHGG/UHGP) v2.0**
Global catalog of human gut microbiome genomes, representing 31 countries across six continents. Version 2.0 additionally includes the Broad Institute-OpenBiome Microbiome Library, which represents the most comprehensive collection of human gut cultures (Poyet et al. Nature Medicine (2019). This dataset is comprised of 289,232 nonredundant genomes from 4,744 prokaryotic species representatives encoding >170 million protein sequences. More than 70% of the UHGG species lack cultured representatives, and 40% of the UHGP lack functional annotations.

#### **Human Reference Gut Microbiome - Korean, India, Japanese datasets (HRGM-KIJ)**
Addition to the UHGG v1 adding 845 human gut microbiome samples from under-represented populations. Whole genome assembly was conducted on 90, 110 and 645 fecal samples from Korea, India and Japan, respectively. 
=======
...
>>>>>>> 7bcaa612483cba9e658793ac815a2e0b5f0a207e

#### **Early-Life Gut Genomes (ELGG)**
ELGG contains 32,277 genomes representing 2172 species from 6122 fecal metagenomes collected from children under 3 years old spanning delivery mode, gestational age, feeding pattern, and geography. The ELGG substantially expanded the phylogenetic diversity by 38% over the isolate microbial genomes, and the genomic landscape of the early-life microbiome by increasing recruitment of metagenomic reads to 82.8%. More than 60% of the ELGG species lack an isolate representative. The conspecific genomes of the most abundant species from children differed in gene diversity and functions compared to adults. The ELGG genomes encode over 80 million protein sequences, forming the Early-Life Gut Proteins (ELGP) catalog with over four million protein clusters, 29.5% of which lacked functional annotations.

<<<<<<< HEAD
#### **Hadza**
Ultra-deep metagenomic sequencing and strain cultivation on 351 fecal samples from the Hadza, hunter-gatherers in Tanzania, and comparative populations in Nepal and California. 
This data set contains 94,971 genomes of bacteria, archaea, bacteriophages, and eukaryotes, 43% of which are absent from existing unified datasets. 

#### **RUMMETA**
A ruminant gastrointestinal microbial reference catalog with 154,335,274 nonredundant genes and 8,745 uncultured species from over 10,373 metagenome-assembled genomes (MAGs). This genome compendia was built from 370 gastrointestinal (GIT) content samples, spanning 10 different GIT regions sampled from seven ruminant species (dairy cattle, Bos taurus; water buffalo, Bubalus bubalis; yak, Bos grunniens; goat, Capra aegagrus; sheep, Ovis aries; roe deer, Capreolus pygargus; water deer, Hydropotes inermis).

#### **Rumen-Uncultured Genomes (RUGs)**
4,941 rumen microbial metagenome-assembled genomes (MAGs) using approximately 6.5 terabases of short- and long-read sequence data from 283 ruminant cattle. Our set of rumen MAGs increases the rate of mapping of rumen metagenomic sequencing reads from 15% to 50–70%. These genomic and protein resources will enable a better understanding of the structure and functions of the rumen microbiota.
...
>>>>>>> 7bcaa612483cba9e658793ac815a2e0b5f0a207e
#### **EuPathDB**
https://academic.oup.com/nar/article/41/D1/D684/1059841

<<<<<<< HEAD
EuPathDB includes 11 databases (AmoebaDB, CryptoDB, FungiDB, GiardiaDB, HostDB, MicrosporidiaDB, OrthoMCLDB, PiroplasmaDB, PlasmoDB, ToxoDB, TrichDB, TriTrypDB, and VectorBase) which together represent 689 eukaryotic microorganisms. This data includes both known pathogens and other closely related non-infectious eukaryotic species.

#### **Metagenomic Gut Virus catalogue (MGV)**
https://www.nature.com/articles/s41564-021-00928-6#Sec2 

189,680 viral genomes from 11,810 publicly available human stool metagenomes with 11,837,198 non-redundant proteins identified. Over 75% of genomes represent double-stranded DNA phages that infect members of the Bacteroidia and Clostridia classes. Sequence clustering reveals 54,118 candidate viral species, 92% of which were not found in existing databases. The Metagenomic Gut Virus catalogue improves detection of viruses in stool metagenomes and accounts for nearly 40% of CRISPR spacers found in human gut Bacteria and Archaea. 

#### **WormBase**
https://academic.oup.com/nar/article/48/D1/D762/5603222 
Databases consisting of 210 genomes, representing 169 distinct species from the Nemotoda (Roundworm) and Plathelminthes (Flatworm) phyla.
=======
...
<<<<<<< HEAD
Collect summary data for each catalog

```{r, eval=FALSE}
catalog_protein_n <- list()
for (catalog in names(catalog_paths)) {
  message("Counting proteins in: ", catalog)
  catalog_protein_n[[catalog]] <- 
    shell_do(
        glue("grep -c '^>' {catalog_paths[[catalog]]}"),
        stdout_path = TRUE
    )  %>% 
    as.numeric
}
...
Collect summary metrics for each clustered catalog
```{r, eval=FALSE}
...
# OLDER function to divide original fasta into N smaller fasta files, roughly even in size
# This function has dramatically reducted performance with larger files
...
```
=======
>>>>>>> 7887d3252e1cca69594f4c2cc982341465d3d5ce
>>>>>>> 7bcaa612483cba9e658793ac815a2e0b5f0a207e
