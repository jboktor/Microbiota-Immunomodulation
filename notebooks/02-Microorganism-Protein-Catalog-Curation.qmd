...
#### **WormBase**
Total: 210 genomes, representing 169 distinct species.
includes some common gut parasites of mammals 
...
protein_cat_dir <- glue("{protein_catalogs}/clustered_catalogs/merged/bins")
shell_do(glue("mkdir -p {protein_cat_dir}"))
fout %<-% {
  chunk_fasta_file(
    protein_cat_dir,
    glue(
      "/central/groups/MazmanianLab/joeB/Downloads/protein_catalogs",
      "/clustered_catalogs/merged/",
